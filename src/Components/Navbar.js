    ...
    return (
        ...
        <>
            <nav className='navbar'>
                <Link to='/' className='nav-logo' onClick={closeSideDrawer}>WEBSITE</Link>
                ...
                <li>
                    <Link to='/products' className='nav-links' onClick={closeSideDrawer}>Products</Link>
                    </li>
                <li>
                    <Link to='/about' className='nav-links' onClick={closeSideDrawer}>About</Link>
                </li>
                <li>
                    <Link to='/services' className='nav-links' onClick={closeSideDrawer}>Services</Link>
                </li>
                <li>
